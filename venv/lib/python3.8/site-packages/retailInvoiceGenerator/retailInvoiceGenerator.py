...
""" For generating invoice in pdf using the input data provided"""
class InvoiceGenerator:
    ...
    def generate_invoice(self, output_path='invoice.pdf'):
        ...
        customer_info = Paragraph(
            f"Customer: {self.customer_name}<br/>Transaction ID: {self.transaction_id}<br/>Order Date: {self.format_date(self.order_date)}",
            styles['Normal'])
    ...
    """ For uploading generated s3(optional)  """
